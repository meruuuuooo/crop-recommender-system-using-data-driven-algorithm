...
export default function ViewCropCard({ crop }: ShowCropCardProps) {
    ...
    const InfoField = ({
        ...
        <div className={`space-y-3 ${fullWidth ? 'col-span-full' : ''}`}>
            ...
            <div className={`flex min-h-[42px] items-center rounded-lg border px-4 py-3 transition-colors ${
                highlight
                    ? 'border-[#619154]/30 bg-[#619154]/5 text-[#619154] font-medium'
    ...
    const parseTimeOfPlanting = (timeOfPlanting: string) => {
        ...
        const parts = timeOfPlanting.toLowerCase()
            .split(/[/,\s-]+/)
            .map(part => part.trim())
    ...
    const CropCalendar = () => {
        ...
        // Debug logging
        console.log('Time of planting:', crop.time_of_planting);
        console.log('Parsed planting months:', plantingMonths);
                ...
                <CardContent>
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-12 gap-1 mb-2">
                            {months.map((month) => (
                                <div key={month} className="text-center text-xs font-medium text-gray-700 py-2">
                                    {month}
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-gray-200">
                            <div className="flex items-center gap-2">
                                <div className="w-4 h-4 bg-[#619154] rounded border border-[#619154]"></div>
                        ...
                        {/* Calendar Info */}
                        <div className="bg-[#F8FAF8] p-4 rounded-lg border border-[#D6E3D4]">
                            ...
                            <div className="pt-3 border-t border-[#D6E3D4]/50">
                                <p className="text-xs text-gray-600 italic">
                                    <span className="font-medium">Note:</span> DAP = Days after planting; DAT = Days after transplanting; DAS = Days after sowing
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div className="w-full space-y-6 sm:p-4 lg:p-6">
                ...
                <CardHeader className="pb-6">
                    <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center gap-4">
                            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#619154]/10 border-2 border-[#619154]/20">
                                <Sprout className="h-8 w-8 text-[#619154]" />
                            </div>
                            <div>
                                <CardTitle className="text-3xl font-bold text-gray-900 mb-2">{crop.name}</CardTitle>
                                <p className="text-sm text-gray-600">Agricultural Crop Information</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            <Badge variant="secondary" className="border-[#619154]/20 bg-[#619154]/10 text-[#619154] px-3 py-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="border-[#D6E3D4]">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <InfoField icon={Package} label="Volume of Production" value={crop.volume_of_production} />
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="border-[#D6E3D4]">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-lg font-semibold text-gray-900">
                            <Users className="h-5 w-5 text-[#619154]" />
                            Population & Spacing
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <InfoField icon={Users} label="Plant Population per Hectare" value={crop.plant_population_per_hectare} highlight />
                        <InfoField icon={Ruler} label="Distance Between Hills" value={crop.distance_of_planting_hills} />
                        <InfoField icon={Ruler} label="Distance Between Rows" value={crop.distance_of_planting_rows} />
                    </CardContent>
                </Card>
                ...
                <Card className="border-[#D6E3D4]">
                    ...
                    <CardContent className="space-y-4">
                        <InfoField icon={TrendingUp} label="Expected Yield per Hectare" value={crop.yield_per_hectare} highlight />
                        <InfoField icon={Package} label="Volume of Production" value={crop.volume_of_production} highlight />
                        <InfoField icon={Timer} label="Maturity Period" value={crop.maturity} />
                    </CardContent>
                </Card>
            </div>
