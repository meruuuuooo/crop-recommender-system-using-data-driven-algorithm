                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                            ...
                            <CardHeader className="space-y-3 p-4 sm:p-6">
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                    <div className="space-y-1">
                                        <CardTitle id="soil-data-heading" className="text-base font-semibold text-gray-900 sm:text-lg">
                                                ...
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent>
                                                        <p className="max-w-xs text-xs">
                                                            Aids in vegetative growth (leaves, stems) and is a core component of chlorophyll.
                                                        </p>
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent>
                                                        <p className="max-w-xs text-xs">
                                                            Promotes root development, accelerates crop maturation, and increases the
                                                            grain/fruit-to-stalk ratio.
                                                        </p>
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent>
                                                        <p className="max-w-xs text-xs">
                                                            Enhances produce quality (flavor, color, size), boosts disease resistance, and improves
                                                            drought tolerance.
                                                        </p>
                                                    </TooltipContent>
                                                </Tooltip>
                        ...
                        <Card className="rounded-xl shadow-sm">
                            <CardHeader className="space-y-3 p-4 sm:p-6">
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                    <div className="space-y-1">
                                        <CardTitle id="climate-data-heading" className="text-base font-semibold text-gray-900 sm:text-lg">
                                            Climate Data
                                        </CardTitle>
                                        <p className="text-xs text-gray-600 sm:text-sm">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="max-w-xs text-xs">
                                                    Regulates key processes like germination and flowering. Each crop has an optimal temperature
                                                    range.
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="max-w-xs text-xs">
                                                    Most plants thrive in 40-80% humidity. High levels can promote disease.
                                                </p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                        ...
                                        <AccordionItem value="hybrid-guideline" className="border-none">
                                            <AccordionTrigger className="px-3 py-3 transition-all duration-200 hover:no-underline sm:px-4 [&[data-state=open]>div>svg]:rotate-180">
                                                <div className="flex items-center gap-2 text-blue-900">
                                                    ...
                                                    <span className="text-xs font-semibold sm:text-sm">How Crop Recommendations Are Determined</span>
                                                </div>
                                            </AccordionTrigger>
                                            <AccordionContent className="px-3 pb-4 duration-300 animate-in fade-in-50 slide-in-from-top-2 sm:px-4">
                                                <div className="space-y-2 text-xs text-blue-800">
                                                    <p>
                                                        The system uses a <strong>hybrid approach</strong> that blends
                                                        <strong> machine learning</strong> (data patterns) and
                                                        <strong> expert agricultural rules</strong> to identify the most suitable crops.
                                                    </p>

                                                    <ul className="ml-4 space-y-1">
                                                        <li>
                                                            🌱 <strong>Data Analysis:</strong> Examines soil nutrients (N, P, K, pH) and climate
                                                            factors like temperature and rainfall.
                                                        </li>
                                                        <li>
                                                            🧠 <strong>Machine Learning:</strong> Predicts how well each crop performs in similar past
                                                            conditions.
                                                        </li>
                                                        <li>
                                                            📋 <strong>Expert Rules:</strong> Filters results based on fertilizer needs and known crop
                                                            requirements.
                                                        </li>
                                                        <li>
                                                            ✅ <strong>Final Score:</strong> Combines both results into a 0–100% suitability rating.
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:flex lg:flex-wrap">
                                                        <div className="flex items-center gap-1.5">
                                                            ...
                                                            <span>
                                                                <strong>90–100%:</strong> Highly suitable
                                                            </span>
                                                        </div>
                                                        <div className="flex items-center gap-1.5">
                                                            <div className="h-3 w-3 rounded-sm bg-yellow-500"></div>
                                                            <span>
                                                                <strong>70–89%:</strong> Moderately suitable
                                                            </span>
                                                        </div>
                                                        <div className="flex items-center gap-1.5">
                                                            <div className="h-3 w-3 rounded-sm bg-orange-500"></div>
                                                            <span>
                                                                <strong>Below 70%:</strong> Needs soil or fertilizer adjustments
                                                            </span>
                                                        </div>
                                                    </div>

                                                    <p className="mt-2 text-blue-700 italic">
                                                        “AI finds the best crops based on soil and climate data — experts ensure the results are
                                                        realistic and field-ready.”
                                                    </p>
                                                </div>
                                            </AccordionContent>
                                        </AccordionItem>
                        ...
                        <CardContent className="p-4 sm:p-6">
                            {recommendationResult.length === 0 ? (
                                <div className="py-8 text-center text-gray-500 sm:py-12">
                                    <div
                                        className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 sm:h-16 sm:w-16"
                                        aria-hidden="true"
                                    >
